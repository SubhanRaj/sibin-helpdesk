/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 9cb790fb1b672c6bd533a24fe218e71b)
// Runtime types generated with workerd@1.20260301.1 2026-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		sibin_helpdesk_db: D1Database;
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* sibin-helpdesk */;
	}
}
